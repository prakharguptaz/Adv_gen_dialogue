...
class MaskHierarchical(MaskFn):
  def __init__(self, p=0.03, mask_document_p=0.03, mask_paragraph_p=0.03, verse=False):
    if not verse:
    ...
    self.p = p
    self.verse = verse
    self.mask_document_p = mask_document_p
    self.mask_paragraph_p = mask_paragraph_p
  ...
  def mask(
    ...
    mask_document_p = self.mask_document_p if mask_document_p is None else mask_document_p
    mask_paragraph_p = self.mask_paragraph_p if mask_paragraph_p is None else mask_paragraph_p
